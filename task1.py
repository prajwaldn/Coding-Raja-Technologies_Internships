 ...
 "cells": [
  {
   ...
   "source": [
    "import pandas as pd\n",
    "movies = pd.read_csv(r\"C:\\Users\\vishw\\Downloads\\ml-25m\\ml-25m\\movies.csv\")\n",
    "movies.head()"
   ]
  },
  {
   ...
   "outputs": [
    {
     "data": {
      "application/vnd.jupyter.widget-view+json": {
       "model_id": "2cc51b90c5e4457bb8f20f9d922825bb",
       "version_major": 2,
       "version_minor": 0
      },
      "text/plain": [
    ...
    },
    {
     "data": {
      "application/vnd.jupyter.widget-view+json": {
       "model_id": "6cf03128c1644a1d81699e492688413e",
       "version_major": 2,
       "version_minor": 0
      },
      "text/plain": [
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "ratings = pd.read_csv(r\"C:\\Users\\vishw\\Downloads\\ml-25m\\ml-25m\\ratings.csv\")"
   ]
  },
  {
   "cell_type": "code",
   ...
   "outputs": [
    {
     "data": {
      "application/vnd.jupyter.widget-view+json": {
       "model_id": "b79e3ff1bba145b3b2ec6c4dbe0b7fc6",
       "version_major": 2,
       "version_minor": 0
      },
      "text/plain": [
    ...
    },
    {
     "data": {
      "application/vnd.jupyter.widget-view+json": {
       "model_id": "feb240905b714f65af9198ee0ebbf214",
       "version_major": 2,
       "version_minor": 0
      },
      "text/plain": [
  ...
  },
  {
   ...
   "source": [
    ...
    "app = Flask(__name__)\n",
    "\n",
    "# Sample movie recommendation function\n",
